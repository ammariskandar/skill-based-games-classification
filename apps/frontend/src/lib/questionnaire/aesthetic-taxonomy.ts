...
export const PRIMARY_OPTIONS: readonly AestheticOption[] = [
  ...
  {
    optionId: "OPT_F1",
    label: "I get to turn things I envision into a reality",
  ...
  {
    optionId: "OPT_F4",
    label: "I get to improve on mistakes others have made in the past",
    category: AestheticCategory.FANTASY,
  },
  {
    optionId: "OPT_N1",
  ...
  {
    optionId: "OPT_N2",
    label: "I really enjoy the character development",
    category: AestheticCategory.NARRATIVE,
  },
  {
    optionId: "OPT_C1",
  ...
  {
    optionId: "OPT_C2",
    label: "I feel like I am much better than everyone in this game",
    category: AestheticCategory.CHALLENGE,
  },
  {
    optionId: "OPT_C3",
