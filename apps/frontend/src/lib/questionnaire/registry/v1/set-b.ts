...
const PART1: QuestionNode[] = [
  question(
    ...
    { target: CHALLENGE, keyPhrase: "real-time control" },
  ),
  question(
    "Q4",
    ...
    [
      ...
      opt("Better execution: Learn attacks, patterns, timing, or movement.", {
        next: "Q4B",
      }),
      opt(
    ...
    { target: CHALLENGE, keyPhrase: "gets the player past it" },
  ),
  question(
    "Q4A",
    ...
    [
      ...
      opt("Preparation helps, but skill is still needed", {
        macro: 50,
        micro: 35,
      }),
    ],
  ...
  question(
    ...
    { target: CHALLENGE, keyPhrase: "execution skill" },
  ),
  question(
    "Q4C",
    "What kind of alternative approach is it?",
    [
      opt("Using the world/system: Physics, elements, traps, terrain, etc.", {
        mystiko: 60,
        macro: 40,
      }),
      opt(
    ...
    { target: CHALLENGE, keyPhrase: "alternative approach" },
  ),
  question(
    "Q5",
    "How much must players figure out enemy weaknesses?",
    [
      opt("A lot: Attacks, patterns, weaknesses, or tricks must be learned.", {
        mystiko: 75,
        micro: 25,
      }),
      opt(
      ...
      opt("A little: Enemies are mostly obvious and predictable.", {
        mystiko: -30,
        macro: 40,
      }),
      opt(
    ...
    { target: CHALLENGE, keyPhrase: "figure out enemy weaknesses" },
  ),
  question(
    "Q6",
    ...
    { target: CHALLENGE, keyPhrase: "planning your character or team" },
  ),
  question(
    "Q6A",
    ...
    { target: CHALLENGE, keyPhrase: "planning matters most" },
  ),
  question(
    "Q6B",
    ...
    [
      ...
      opt("Looks/roleplay matter more than numbers", {
        mystiko: 50,
        micro: 20,
      }),
    ],
  ...
  question(
    ...
    { target: CHALLENGE, keyPhrase: "where you are" },
  ),
  question(
    "Q8",
    ...
    { target: CHALLENGE, keyPhrase: "find their own way" },
  ),
];
...
const PART2: QuestionNode[] = [
  ...
  question(
    ...
    { target: REWARD, keyPhrase: "How are they obtained" },
  ),
  question(
    "Q9B",
    ...
    { target: REWARD, keyPhrase: "power progression" },
  ),
  question(
    "Q10",
    ...
    { target: REWARD, keyPhrase: "biggest sense of wonder" },
  ),
  question(
    "Q11",
    ...
    { target: REWARD, keyPhrase: "save disappeared" },
  ),
  question(
    "Q11A",
    ...
    { target: REWARD, keyPhrase: "collection assembled" },
  ),
  question(
    "Q12",
    ...
    { target: REWARD, keyPhrase: "status or prestige" },
  ),
  question(
    "Q13",
    ...
    [
      ...
      opt("Nothing much: The game remains comfortable to play.", {
        mystiko: 90,
      }),
    ],
    { target: REWARD, keyPhrase: "What becomes hardest" },
  ),
  question(
    "Q13A",
    ...
    { target: REWARD, keyPhrase: "hardest to read or manage" },
  ),
  question(
    "Q14",
    ...
    { target: REWARD, keyPhrase: "biggest payoff" },
  ),
];
