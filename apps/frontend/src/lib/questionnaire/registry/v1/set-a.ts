 ...
 *
 * Mirrors `apps/backend/classifications/questionnaire/registry/v1/set_a.py`.
...
const PART1: QuestionNode[] = [
  question(
    ...
    { target: CHALLENGE, keyPhrase: "precise physical input" },
  ),
  question(
    "Q4",
    ...
    { target: CHALLENGE, keyPhrase: "order of actions" },
  ),
  question(
    "Q4A",
    ...
    { target: CHALLENGE, keyPhrase: "in the wrong order" },
  ),
  question(
    "Q4B",
    ...
    { target: CHALLENGE, keyPhrase: "choosing your own order" },
  ),
  question(
    "Q4C",
    ...
    { target: CHALLENGE, keyPhrase: "change what happens later" },
  ),
  question(
    "Q5",
    ...
    { target: CHALLENGE, keyPhrase: "hide useful tricks or rules" },
  ),
  question(
    "Q6",
    ...
    [
      ...
      opt("High: There is frequent physical input, but regular breaks exist.", {
        micro: 65,
      }),
      opt("Low: Inputs are occasional or comfortably paced.", { micro: 20 }),
      opt("Very low: Most actions are slow, menu-based, or turn-based.", {
        micro: -20,
      }),
    ],
    { target: CHALLENGE, keyPhrase: "fast or continuous input" },
  ),
  question(
    "Q7",
    ...
    { target: CHALLENGE, keyPhrase: "predicting what happens next" },
  ),
  question(
    "Q8",
    "Does the game calculate success using stats (i.e. HP, damage, levels, gear)?",
    [opt("Yes", { next: "Q8A" }), opt("No", { next: "Q8B" })],
    { target: CHALLENGE, keyPhrase: "calculate success using stats" },
  ),
  question(
    "Q8A",
    ...
    { target: CHALLENGE, keyPhrase: "What matters most" },
  ),
  question(
    "Q8B",
    "Does the game mainly revolve around repeating a physical action?",
    [opt("Yes", { next: "Q8C" }), opt("No", { micro: -20, next: "Q8D" })],
    { target: CHALLENGE, keyPhrase: "repeating a physical action" },
  ),
  question(
    "Q8C",
    ...
    { target: CHALLENGE, keyPhrase: "mastering that action" },
  ),
  question(
    "Q8D",
    "Does the game use text, dialogue, or narration heavily?",
    [opt("Yes", { next: "Q8E" }), opt("No", { next: "Q8F" })],
    { target: CHALLENGE, keyPhrase: "text, dialogue, or narration" },
  ),
  question(
    "Q8E",
    "During those sections, how much physical control does the player still have?",
    [
      opt("No physical control: The player mostly reads, chooses, or waits.", {
        mystiko: 10,
      }),
      opt(
    ...
    { target: CHALLENGE, keyPhrase: "physical control" },
  ),
  question(
    "Q8F",
    "Does the game require solving puzzles or figuring things out?",
    [
      opt("Yes: Progress depends on solving puzzles, clues, or deductions.", {
        mystiko: 40,
      }),
      opt("No: Navigation and objectives are mostly straightforward.", {
        mystiko: -10,
      }),
    ],
    { target: CHALLENGE, keyPhrase: "solving puzzles" },
  ),
];
...
const PART2: QuestionNode[] = [
  question(
    ...
    { target: REWARD, keyPhrase: "unlockable rewards" },
  ),
  question(
    "Q9A",
    ...
    [
      ...
      opt(
        ...
        { micro: 25, macro: 30, next: "Q9C" },
      ),
      opt("Both: Players can earn cosmetics and also buy them.", {
        micro: 40,
        macro: 30,
        next: "Q9C",
      }),
    ],
    { target: REWARD, keyPhrase: "cosmetics mainly earned" },
  ),
  question(
    "Q9B",
    "What kind of progression reward matters most?",
    [
      opt("Bigger numbers: Better damage, stats, levels, equipment, etc.", {
        macro: 80,
        next: "Q9E",
      }),
      opt(
    ...
    { target: REWARD, keyPhrase: "progression reward matters most" },
  ),
  question(
    "Q9C",
    "Can players trade those cosmetics?",
    [
      opt("Yes: Players can buy, sell, or trade them.", {
        macro: 40,
        next: "Q9D",
      }),
      opt("No: They stay with the player's account/save.", {
        micro: 30,
        macro: 20,
        next: "Q9D",
      }),
    ],
    { target: REWARD, keyPhrase: "trade those cosmetics" },
  ),
  question(
    "Q9D",
    "Are there also gameplay-changing unlocks?",
    [opt("Yes", { next: "Q9E" }), opt("No", { micro: -20, macro: -20 })],
    { target: REWARD, keyPhrase: "gameplay-changing unlocks" },
  ),
  question(
    "Q9E",
    "How much do those unlocks change gameplay?",
    [
      opt("A lot: They add major abilities or significantly increase power.", {
        micro: 20,
        next: "Q9F",
      }),
      opt(
        "Somewhat: They offer different but reasonably balanced ways to play.",
        { micro: 10, macro: 20, next: "Q9F" },
      ),
      opt(
        "Not at all: They mainly exist for appearance, story, or collection.",
        { macro: -10, mystiko: 15, next: "Q9F" },
      ),
    ],
    { target: REWARD, keyPhrase: "unlocks change gameplay" },
  ),
  question(
    "Q9F",
    ...
    { target: REWARD, keyPhrase: "rank or leaderboard" },
  ),
  question(
    "Q10",
    ...
    { target: REWARD, keyPhrase: "moment-to-moment satisfaction" },
  ),
  question(
    "Q11",
    ...
    [
      ...
      opt("Shared memories and things built with others", {
        micro: 40,
        mystiko: 30,
      }),
    ],
    { target: REWARD, keyPhrase: "biggest loss" },
  ),
  question(
    "Q11A",
    ...
    { target: REWARD, keyPhrase: "How relaxing is the game" },
  ),
  question(
    "Q12",
  ...
  question(
    ...
    { target: REWARD, keyPhrase: "becomes harder when tired" },
  ),
  question(
    "Q13",
    "Do you enjoy watching clips or streams of the game being played by other people (i.e. YouTube, Twitch)?",
    [opt("Yes", { next: "Q13A" }), opt("No", { next: "Q13B" })],
    { target: REWARD, keyPhrase: "watching clips or streams" },
  ),
  question(
    "Q13A",
    ...
    [
      ...
      opt("Unexpected chaos: Funny, strange, or unpredictable things happen.", {
        mystiko: 10,
      }),
      opt(
      ...
      opt("Competition: Watching coordinated high-level matches.", {
        micro: 15,
        macro: 50,
      }),
      opt(
    ...
    { target: REWARD, keyPhrase: "interesting to watch" },
  ),
  question(
    "Q13B",
    ...
    { target: REWARD, keyPhrase: "especially interesting to watch" },
  ),
  question(
    "Q14",
    ...
    { target: REWARD, keyPhrase: "biggest weakness" },
  ),
  question(
    "Q14A",
    ...
    { target: REWARD, keyPhrase: "most underrated strength" },
  ),
];

export const SET_A: QuestionSetDefinition = buildSet(
  "A",
  "Sensory",
  PART1,
  PART2,
