...
│   │   └── source_policy.py    # Source-specific capability helpers — SBGC-61
│   ├── tests/
│   │   ├── services/steam/
